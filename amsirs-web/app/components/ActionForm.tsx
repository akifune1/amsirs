    ...
    <>
      ...
      {showModal && (
        ...
        >
          ...
          >
            <div className="px-5 py-4 border-b border-zinc-100 bg-red-50/50 flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-red-100 text-red-600 flex items-center justify-center flex-shrink-0">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"></path></svg>
              </div>
              <div>
                <h3 className="font-bold text-red-700 text-base">Action Required</h3>
                <p className="text-xs text-red-600/80 font-medium">Please confirm this operation</p>
              </div>
            </div>
            
            <div className="p-6 text-center">
              <p className="text-zinc-700 font-medium">{confirmMessage}</p>
            </div>
